...
Fibration of a Ball: Explaining 3D objects to a "flat friend" by showing 2D circular cross-sections over time


https://github.com/user-attachments/assets/5aec21f0-2b1a-4733-b988-0fc75d969700



Möbius Strip Fibration: Demonstrating how a Möbius strip can be decomposed into a family of interlocking circles.



https://github.com/user-attachments/assets/d83e546d-5666-4f6b-9206-fa1436183348



Hopf Fibration: Representation of $S^3$ using complex numbers: $|z_1|^2 + |z_2|^2 = 1$.



https://github.com/user-attachments/assets/a8e08185-60c4-4c3e-a388-8fb836cabb4d



Mapping circles in $S^3$ to points on the Riemann sphere ($S^2$) via the Hopf map: $h(z_1, z_2) = z_1 / z_2$

Visualizing the result as nested tori composed of Villarceau circles.
...
Author: @LyudmilaSutotskaya (Telegram)
